...
| Cost Efficiency | The evidence model estimates `$0.005836` per correct update on the prototype and includes per-1,000-record cost scenarios. | `appendix/COST_MODEL.md`, `evidence/cost_model_per_1000.csv` |
