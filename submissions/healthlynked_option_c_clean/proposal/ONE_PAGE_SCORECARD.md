...
| Scalability | The production plan separates cheap deterministic source checks from bounded LLM fallback and scales with managed workflows, object storage, containers/functions, queues, and relational/key-value storage (AWS examples included). | `proposal/TECHNICAL_ARCHITECTURE_PROPOSAL.md`, `appendix/AWS_PRODUCTION_ARCHITECTURE.md` |
