...
```bash
python3 scripts/verify_pipeline.py --package submissions/exp0136_final_hybrid_mvp_package.zip --out-dir outputs/reproduce_verify
```
...
```bash
unzip -l submissions/exp0136_final_hybrid_mvp_package.zip | head -80
```
