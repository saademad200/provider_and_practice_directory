...
This document maps the local provider-directory prototype to a cloud-agnostic production deployment with portable service boundaries. AWS services are used as concrete reference examples for the 90 day handoff.
